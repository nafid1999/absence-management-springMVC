...
public class PersonServiceImpl implements IPersonService {
	...
	public Utilisateur getEtudiantByCne(String cne) {
		List<Utilisateur> u = personDao.getEntityByColValue("Etudiant", "cne", cne);
		if (u != null && u.size() != 0) {
			Utilisateur etu=personDao.findById(u.get(0).getIdUtilisateur());
