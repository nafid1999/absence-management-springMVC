			...
			<ul class="dropdown-menu" aria-labelledby="navbarScrollingDropdown">
				...
				<li class="dropdown-item"><a class="nav-link"
					href="${pageContext.request.contextPath}/admin/manageAccounts">List
						Accounts</a></li>
						<li class="dropdown-item"><a class="nav-link"
					href="${pageContext.request.contextPath}/admin/historique">historiques de connexion</a></li>
			
                 <li class="dropdown-item"><a class="nav-link" 
					href="${pageContext.request.contextPath}/admin/actions">actions des utilisateurs</a></li>
